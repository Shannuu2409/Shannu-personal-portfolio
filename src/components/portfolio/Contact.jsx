  ...
  return (
    <section id="contact" className="scroll-mt-24">
      <div className="max-w-3xl mx-auto px-6 lg:px-10 py-20">
        <motion.h2 variants={sectionVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.5 }} className="text-3xl font-bold flex items-center gap-3">
          <span className="font-mono text-accent">03.</span> Contact
        </motion.h2>

        <motion.p variants={sectionVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.5, delay: 0.1 }} className="mt-3 text-gray-400">
          Feel free to reach out for opportunities, collaborations, or just to say hi.
        </motion.p>

        <motion.form onSubmit={onSubmit} variants={sectionVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.5, delay: 0.15 }} className="mt-8 grid gap-4">
        ...
        <motion.div variants={sectionVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.5, delay: 0.2 }} className="mt-10 rounded-lg border bg-gray-800 p-4">
          <details>
